namespace S {
  ...
  export const MobileMenuContainer = "block md:invisible";

  export const HeaderSearchBarContainer = "w-[500px] relative";

  export const SearchDropDownContainer = "absolute t-[10px]";
}
